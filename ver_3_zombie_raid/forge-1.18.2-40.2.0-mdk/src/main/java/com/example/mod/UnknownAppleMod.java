...
public class UnknownAppleMod {
    ...
    private static final Log LOGGER = LogFactory.getLog(UnknownAppleMod.class);
    ...
    public void onZombieDeath(LivingDeathEvent event) {
        ...
        if (event.getEntity() instanceof Zombie &&
            ...
            LOGGER.info("좀비가 죽었고, 알 수 없는 사과를 드랍했습니다.");
            // 10% 확률로 아이템 드랍
...
//                Zombie zombie = (Zombie) event.getEntity();
//                ItemStack unknownAppleStack = new ItemStack(UNKNOWN_APPLE.get());
//                zombie.drop(unknownAppleStack);  // 아이템 드랍
//            }
//        }
//    }
